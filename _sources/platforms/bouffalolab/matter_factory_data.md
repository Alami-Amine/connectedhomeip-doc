...
> script
> [generate_factory_data.py](https://github.com/project-chip/connectedhomeip/blob/master/scripts/tools/bouffalolab/generate_factory_data.py)
...
-   Default setting uses the following parameters
    ...
    -   PAI certification:
        [test PAI certification](https://github.com/project-chip/connectedhomeip/blob/master/credentials/test/attestation/Chip-Test-PAI-FFF1-8000-Key.pem)
