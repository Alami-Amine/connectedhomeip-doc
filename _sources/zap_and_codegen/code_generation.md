...
You can read the
[scripts/py_matter_idl/matter_idl/README.md](https://github.com/project-chip/connectedhomeip/blob/master/scripts/py_matter_idl/matter_idl/README.md)
...
composition is spec compliant (see [Testing](https://github.com/project-chip/connectedhomeip/blob/master/../testing))
