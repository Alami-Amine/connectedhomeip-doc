...
-   To enable the
    [matter CLI](https://github.com/project-chip/connectedhomeip/blob/master/README.md#testing-the-all-clusters-application-with-matter-cli-enabled),
...
-   To build the application with the OTA Requestor enabled, the arguments
    ...
    [OTA Requestor README](../../../../../platforms/nxp/nxp_RTs_ota_software_update.md)
...
![MCU_Set](../../../../../../../../examples/platform/nxp/rt/rw61x/doc/images/mcu-set.PNG)
...
dedicated guide
['Matter Over-The-Air Software Update with NXP RW61x example applications'](../../../../../platforms/nxp/nxp_RTs_ota_software_update.md).
