...
[src/python_testing](https://github.com/project-chip/connectedhomeip/blob/master//src/python_testing)):
...
-   See chip-repl documentation in:
    -   [Working with Python CHIP Controller](../../../development_controllers/chip-repl/python_chip_controller_building.md)
    -   [Matter_REPL_Intro](https://github.com/project-chip/connectedhomeip/blob/master/development_controllers/chip-repl/Matter_REPL_Intro.ipynb)
