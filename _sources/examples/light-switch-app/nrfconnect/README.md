...
Check the
[CLI user guide](../../../platforms/nrf/nrfconnect_examples_cli.md) to
...
the
[CHIP Tool's user guide](../../../development_controllers/chip-tool/chip_tool_guide.md#interacting-with-data-model-clusters)
...
1.  Build the CHIP Tool according to the steps from the
    [CHIP Tool user guide](../../../development_controllers/chip-tool/chip_tool_guide.md#building-from-source).
